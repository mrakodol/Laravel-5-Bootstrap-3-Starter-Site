@extends('site.layouts.default') @section('carousel')
@if(count($sliders)>0)
<div id="myCarousel" class="carousel slide">
	<div class="carousel-inner">
		...
		<div class="item @if($key == 0) active @endif">
			<img
				src="{{'images/photoalbum/'.$item->folderid.'/'.$item->filename }}"
				alt="{{$item->name}}">
			<div class="container">
	...
	@if(count($sliders)>1) <a class="left carousel-control"
		href="#myCarousel" data-slide="prev"><span
		class="glyphicon glyphicon-chevron-left fa-2x"></span></a> <a
		class="right carousel-control" href="#myCarousel" data-slide="next"><span
		class="glyphicon glyphicon-chevron-right fa-2x"></span></a> @endif
</div>
...
<div class="row">
	...
	<div class="col-md-6">
		<div class="row">
			<div class="col-md-8">
				<h4>
					<strong><a href="{{URL::to('news/'.$post->id.'/item')}}">{!!
							$post->title !!}</a></strong>
				</h4>
			</div>
		</div>
		<div class="row">
			<div class="col-md-2">
				<a href="{{URL::to('news/'.$post->id.'/item')}}" class="thumbnail"><img
			...
			<div class="col-md-10">
				...
				<p>
					<a class="btn btn-mini btn-default"
						href="{{URL::to('news/'.$post->id.'/item')}}">Read more</a>
				</p>
			</div>
		</div>
		<div class="row">
