...
<!-- ./ tabs -->
@if (isset($photo))
{!! Form::model($photo, array('url' => url('admin/photo') . '/' . $photo->id, 'method' => 'put','id'=>'fupload','class' => 'bf', 'files'=> true)) !!}
@else
{!! Form::open(array('url' => url('admin/photo'), 'method' => 'post', 'class' => 'bf','id'=>'fupload', 'files'=> true)) !!}
@endif
        <!-- Tabs Content -->
